export default function PostForm({ handleSubmit, register, errors, onSubmit,handelOld={} }) {
    return (
      <form
      ...
      >
         {handelOld.id && (
        <input type="hidden" {...register('id')} defaultValue={handelOld.id} />
      )}
        ...
        <input
          ...
          {...register('title', { required: 'Title is required', maxLength: { value: 20, message: 'Max length is 20 characters' } })}
          defaultValue={handelOld.title || ''}
       />
        ...
        <textarea
          ...
          defaultValue={handelOld.body || ''}
          {...register('body', { required: 'Body is required', maxLength: { value: 2000, message: 'Max length is 2000 characters' } })}
        />
